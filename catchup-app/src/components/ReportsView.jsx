    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
        <div className="dashboard-card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 24px', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '4rem', fontWeight: 700, color: 'var(--text)', lineHeight: 1, marginBottom: '8px', letterSpacing: '-0.02em' }}>{recoveryRate}%</div>
          <div style={{ color: 'var(--text-muted)', fontWeight: 600, fontSize: '1rem' }}>Global Recovery Rate</div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', gridColumn: 'span 2' }}>
          <div className="dashboard-card" style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              ...
              <div style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--text)' }}>{currency}{totalRecovered.toLocaleString()}</div>
            </div>
          ...
          <div className="dashboard-card" style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              ...
              <div style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--danger)' }}>{currency}{totalLost.toLocaleString()}</div>
            </div>
            <div style={{ width: '100%', height: '8px', background: 'var(--bg)', borderRadius: '50px', overflow: 'hidden' }}>
